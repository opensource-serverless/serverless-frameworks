...
kubectl run -it --rm --image=mysql:8.0 --restart=Never mysql-client -- mysql -h mysql-replica-0.mysql -p
kubectl run -it --rm --image=mysql:8.0 --restart=Never mysql-client -- mysql -h mysql-replica-1.mysql -p
kubectl run -it --rm --image=mysql:8.0 --restart=Never mysql-client -- mysql -h mysql-replica-2.mysql -p
kubectl run -it --rm --image=mysql:8.0 --restart=Never mysql-client2 -- mysql -h mysql -p
